        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{
          ...
          <TouchableOpacity style={styles.optionsHeader}>
            <View style={styles.optionSlectedHeader}>
              <Image style={{ tintColor: '#0079C3' }} source={require('../../assets/images/mobile--otp.png')} />
            </View>
            <Text style={{ color: '#0179C3' , fontSize: 12}}>Cobro con PIN</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.optionsHeader}
          onPress={() => this.props.navigation.navigate('CobroQR')}>
            ...
            <Text style={{ fontSize: 12 }}>Cobro con QR</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.optionsHeader}>
            <View style={styles.optionHeader}>
        ...
        <ScrollView style={{}}>
          ...
          <View style={{ marginHorizontal: 20, marginVertical: 5 }}>
            <TextInput
              ...
              style={styles.textInput}
            />
            <Text style={{ color: 'grey', fontSize: 11, marginLeft: 10 }}>Ingrese el # de teléfono de la persona a cobrar</Text>
          </View>
          ...
          <View style={{
            ...
            <View style={{
              ...
              onPress={() => this.props.navigation.navigate('IngresoPINCobro')}>
